                ...
                'validators': {
                    ...
                    'phone': {
                        'callback': function (element) {
                            ...
                            return {
                                'valid': false,
                                'message': 'Поле має містити коректний номер телефону.'
                            };
                        }
                    },
                    'email': {
                        'callback': function (element) {
                            ...
                            return {
                                'valid': false,
                                'message': 'Поле має містити коректну адресу електронної пошти.'
                            };
                        }
                    },
                    'comment': {
                        'callback': function (element) {
                            ...
                            if (
                                (new RegExp(/^[АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЬьЮюЯяA-Z0-9'\-ʼ.\s]+$/, 'i').test(value))
                            ) {
                                return {'valid': true};
                            }
                            ...
                            return {
                                'valid': false,
                                'message': 'Дозволені лише латинські та українські літери, цифри та символи \'-ʼ..'
                            };
                        }
                    },
                    'card_number': {
                        'callback': function (element) {
                            ...
                            return {
                                'valid': false,
                                'message': 'Поле має містити коректний номер банківської картки.'
                            };
                        }
                    },
                    'expiry_date': {
                        'callback': function (element) {
                            ...
                            return {
                                'valid': false,
                                'message': 'Поле має містити коректний термін дії банківської картки.'
                            };
                        }
                    },
                    'cvv': {
                        'callback': function (element) {
                            ...
                            return {
                                'valid': false,
                                'message': 'Поле має містити коректний CVV код банківської картки.'
                            };
                        }
                    }
                },
